export type IconName = 'home' | 'grid' | 'check' | 'vault' | 'asset' | 'activity' | 'users' | 'settings' | 'search' | 'arrow' | 'external' | 'folder' | 'file' | 'star' | 'clock' | 'share' | 'upload' | 'more' | 'close' | 'menu' | 'logout' | 'user' | 'download' | 'copy' | 'trash' | 'edit' | 'chevron'
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  asset: <><rect x="6" y="2" width="12" height="20" rx="2"/><path d="M9 5h6M10 18h4"/><circle cx="12" cy="12" r="2"/></>,
