export type IconName = 'home' | 'grid' | 'check' | 'vault' | 'activity' | 'users' | 'settings' | 'search' | 'arrow' | 'external' | 'folder' | 'file' | 'star' | 'clock' | 'share' | 'upload' | 'more' | 'close' | 'menu' | 'logout' | 'user' | 'download' | 'copy' | 'trash' | 'edit' | 'chevron'
